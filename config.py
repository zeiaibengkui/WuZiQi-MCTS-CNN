...
TRAIN_ITERATIONS = 5000  # training iterations (should be 1000+ in practice)

# number of games per model pair per competition round
# will duplicate 2
GAMES_PER_ITER = 1
...
COMPETITION_FREQUENCY = 20  # run competition every n self-play
